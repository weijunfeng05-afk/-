...
const models = [{value:"deepseek-v4-pro",label:"DeepSeek V4 Pro",hint:"复杂岗位理解"},{value:"deepseek-flash",label:"DeepSeek Flash",hint:"快速、低成本"}];

export default function ApiSettingsPage() {
  const [settings,setSettings]=useState<Settings|null>(null), [key,setKey]=useState(""), [show,setShow]=useState(false);
  const [jobModel,setJobModel]=useState("deepseek-v4-pro"), [resumeModel,setResumeModel]=useState("deepseek-flash");
