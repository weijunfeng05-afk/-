...
export type Requirements = {scoring_profile?:Profile['id'];rubric_requirements?:Record<string,string[]>;skills:string[];experience:string[];other:string[];conditions:Condition[]};
...
export const emptyRequirements = ():Requirements => ({skills:[],experience:[],other:[],conditions:[],rubric_requirements:{}});
